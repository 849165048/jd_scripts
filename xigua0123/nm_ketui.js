...
/* 
定时建议  一天运行4次
cron: 1 0,2,10,12 * * * nm_ketui.js
安卓的用户  请固定这个变量   export ketuicookie="Ketui/1.3.2 (Android 7.1.2; OPPO PCAM00)"
对苹果的用户友好  不用写~已内置


接下来是用户变量，多账号用@隔开   打开抓包软件  再打开可推~点击 我的找到开心小矿工 点击进去  再去抓包软件找"https://api.ketui.cn/"的链接，复制请求头的Authorization复制里面的值就行了 
  变量名如下
  export ketuick='xxxxx@xxxxx'
ketuick='软件获取的CK'
